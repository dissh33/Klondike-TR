...
public class IconGetByIdTests : IconTestsSetupBase
{
    ...
    public async Task ShouldReturnCorrectIconDto_WhenIconExists()
    {
        ...
        var iconResult = new Icon("n1", Array.Empty<byte>(), "f1", id);

        _uow.IconRepository.GetById(id, CancellationToken.None).Returns(iconResult);
